...
marc_magic = Collection.create(category: "Magic the Gathering", owner_id: marc_coll.id)
nick_poke = Collection.create(category: "Pokemon", owner_id: nick_coll.id)
laura_poke = Collection.create(category: "Pokemon", owner_id: laura_coll.id)
marc_poke = Collection.create(category: "Pokemon", owner_id: marc_coll.id)
